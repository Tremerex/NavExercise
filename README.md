...
* Technologies used in this app: Javascript, Html, CSS, SCSS
* Package manager: Npm
* Dependency resolver: Webpack
* Transpilator: babel (presets: ES2015, Stage-0)
* Css Preprocessor: node-sass
* e2e test: Selenium standalone (with webdriver.io)
